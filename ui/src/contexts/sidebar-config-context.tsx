...
const defaultMenus: DefaultMenus = {
  ...
  'sidebar.groups.applications': [
    ...
    { titleKey: 'nav.hortonworks', url: '/applications/hortonworks', icon: IconDatabase },
    { titleKey: 'nav.dolphinscheduler', url: '/applications/dolphinscheduler', icon: IconDatabase },
    { titleKey: 'nav.elasticsearch', url: '/applications/elasticsearch', icon: IconDatabase },
    ...
    { titleKey: 'nav.elasticOperator', url: '/applications/elastic-operator', icon: IconDatabase },
